							...
							<div class="card-body p-md-5">
								<div class="row justify-content-center">
									<div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
										...
										<form class="mx-1 mx-md-4" action="update" method="get">
											...
											<div class="d-flex flex-row align-items-center mb-4">
												...
												<label class="form-label" for="form3Example1c">Product-Id
													...
													<input type="number" name="productId" id="form3Example1c" value="<%=product.getProductId() %>" class="form-control" />
											...
											<div class="d-flex flex-row align-items-center mb-4">
												...
												<label class="form-label"
													...
													<input type="text" name="productName" id="form3Example3c" value="<%=product.getProductName() %>"
														class="form-control" /> 
												</div>
											</div>
											...
											<div class="d-flex flex-row align-items-center mb-4">
												...
												<label class="form-label"
													...
													<input type="number" name="productPrice" id="form3Example4c" value="<%=product.getProductPrice() %>"
														class="form-control" /> 
												</div>
											</div>
							...
							<!-- datepicker -->
											...
											<div class="d-flex flex-row align-items-center mb-4">
												...
												<label class="form-label"
													...
													<input type="date" name="expireDate" id="form3Example4cd" value="<%=product.getExpireDate() %>"
														class="form-control" /> 
												</div>
											</div>
